...
namespace Курсовая1._0
{
    ...
    public partial class App : Application
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            try
            {
                string connectString = @"Data Source=localhost;Initial Catalog=master;Integrated Security=True;TrustServerCertificate=True";
                if (!DatabaseExists("KBPClassBeta", connectString))
                {
